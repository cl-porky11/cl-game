...
(defgeneric display-object (object))

(defmethod display-object :around (object)
  (with-html-output-to-string (*standard-output*)
    (call-next-method)))

(defmethod display-object (object)
  (print object))
...
(defmethod display-object ((text text))
  (dolist (line (slot-value text 'lines))
    (princ line)))
...
(define-easy-handler (site :uri "/test") ()
  (with-html-output-to-string (*standard-output*)
    (:div :id "header" "test" (:br) "test2" (:br) "ende")))
